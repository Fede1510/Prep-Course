...
function asAmirror(str) {
  ...
  var array = splitString.map(function(elem){
 //  console.log(elem.split(''));
 // console.log(elem.split('').reverse());
...
function capicua(numero){
  ...
  //Escribe tu código aquí
  var strNumber = numero.toString().split('');
//console.log(strNumber.join(''));
  var numero1 = strNumber.join('')
  var strNumberRev = strNumber.reverse();
// console.log(strNumberRev.join(''));
  var numero2 = strNumberRev.join('')
  if(numero1 === numero2){
    return "Es capicua"
  } else {
...
function deleteAbc(cadena){
  ...
  for(i = 0; i < cadena.length; i++){
    if(cadena[i] === 'a' || cadena[i] === 'b' || cadena[i] === 'c'){
      ...
      resultante = resultante + cadena[i];
    }
  }
  return resultante;
}
